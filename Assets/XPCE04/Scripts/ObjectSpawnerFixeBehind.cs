...
public class ObjectSpawnerFixeBehind : MonoBehaviour
{
  public static bool isObjectReady = true;
	public Transform[] prefabs;
	public int objectToSpawn;
	public bool activeOrNot2 = false;
	...
	void Update()
	{
	    ...
	    if (Input.GetKeyDown(KeyCode.X)) { activeOrNot2 = !activeOrNot2; }
	}
