...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_CustomFunc p_CustomFunc;
        ...
        public static SteamVR_Input_ActionSet_CustomFunc CustomFunc
        {
            get
            {
                return SteamVR_Actions.p_CustomFunc.GetCopy<SteamVR_Input_ActionSet_CustomFunc>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_CustomFunc = ((SteamVR_Input_ActionSet_CustomFunc)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_CustomFunc>("/actions/CustomFunc")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.CustomFunc};
        }
    }
}
