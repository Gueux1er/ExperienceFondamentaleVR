Shader "UB/MirrorsWetSurf" {
    Properties {
        ...
        _ReflEdgeDarkness ("Reflection edge darkness", Range (1, 15)) = 1.0
    ...
    SubShader {
        ...
        uniform float _ReflEdgeDarkness;
        ...
        void surf (Input IN, inout SurfaceOutput o) {
            ...
            o.Emission = //mask.a/5;
                //mask.a<0.7 ? refl *_ReflAmount * mask.a/10 :
                refl *_ReflAmount * pow(mask.a,_ReflEdgeDarkness)+
                //refl *_ReflAmount * mask.a + 
                tex.rgb *_Color.rgb* (1-_ReflAmount) + 
                animColor * pow(mask.a,_ReflEdgeDarkness) * _DropColor;//
